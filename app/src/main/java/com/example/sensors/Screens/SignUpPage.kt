...
import com.example.sensors.Authentication.SignUpUIEvent
        ...
        Surface(
            ...
            Column(modifier = Modifier.fillMaxSize()) {
                ...
                MyTextFieldComponent(
                    "Imię",
                    painterResource = painterResource(id = com.example.sensors.R.drawable.ic_launcher_background),
                    onTextChanged = {
...
fun SignUpPagePreview() {
    ...
    SignUpPage (signupViewModel = viewModel(), signUp = {"Dovtor" }, onLoginClick = {})
}